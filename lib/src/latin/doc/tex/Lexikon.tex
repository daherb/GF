...
\begin{lstlisting}[float=ht,caption={Für \textbf{StructuralLat.gf} nötige \texttt{lincat}-Definitionen für geschlossene Kategorien},label={GF-Structural-Lincat},basicstyle=\small]
param
...
\begin{lstlisting}[float=ht,caption={Erzeugung des \texttt{NP}-Objekts für \texttt{everything\_NP}},label={GF-Structural-Everything},basicstyle=\small]
oper
...
\label{subsec:offene}
\begin{lstlisting}[float=ht,caption={Für \textbf{LexiconLat.gf} nötige \texttt{lincat}-Definitionen für offene Kategorien},label={GF-Lexicon-Lincat},basicstyle=\small]
param 
