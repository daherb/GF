...
\begin{lstlisting}[float=h!tp,label={GF-Structural-in},caption={Beispiel für freie Variation}]
...
\begin{lstlisting}[float=h!tp,caption={Erzeugung des \texttt{NP}-Objekts für \texttt{everything\_NP}},label={GF-Structural-Everything},basicstyle=\small]
oper
