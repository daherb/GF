...
\begin{lstlisting}[float=h!,caption={Ausschnitt aus dem Paradigma des Verbs \texttt{sleep\_V}},label={GF-Sleep-V},basicstyle=\small]
...
...
\begin{lstlisting}[float=h!,caption={Beispiel für ein Smart Paradigm mit Hilfe von Pattern Matching und Fallunterscheidung (vgl. \textbf{MorphoLat.gf})},label={GF-Morpho-Noun}]
oper
...
\begin{lstlisting}[float=h!,caption={Smart Paradigm für zwei Nomenformen und Genus (vgl. \textbf{MorphoLat.gf})},label={GF-Morpho-Noun-NGG}]
oper
...
\begin{lstlisting}[float=h!,caption={Deklinationsfunktion für die erste Deklination},label={GF-Morpho-Noun1}]
oper
  -- a-Declension
...
\begin{lstlisting}[float=h!,caption={Die Deklinationsfunktionen für die Nomen der zweiten Deklination auf \textit{-us}},label={GF-Morpho-Noun2us},basicstyle=\small]
oper
  -- o-Declension
  noun2us : Str -> Noun = \servus ->
    ...
    mkNoun 
      ...
      Masc ;
\end{lstlisting}
\begin{lstlisting}[float=h!,caption={Die Deklinationsfunktionen für die Nomen der zweiten Deklination auf \textit{-um}},label={GF-Morpho-Noun2um},basicstyle=\small]
  noun2um : Str -> Noun = \bellum ->
    ...
    mkNoun 
      ...
      Neutr ;
\end{lstlisting}
\begin{lstlisting}[float=h!,caption={Die Deklinationsfunktionen für die Nomen der zweiten Deklination auf \textit{-er}},label={GF-Morpho-Noun2er},basicstyle=\small]
...
\begin{lstlisting}[float=h!,caption={Funktion zur Zuordnung von Nomen zu den Stämmen der dritten Deklination},label={GF-Morpho-Noun3},basicstyle=\small]
oper
...
\begin{lstlisting}[float=h!,caption={Die Deklinationsfunktionen für die Nomen der dritten Deklination der Konsonantenstämme},label={GF-Morpho-Noun3c},basicstyle=\small]
oper
...
\begin{lstlisting}[float=h!,caption={Die Deklinationsfunktionen für die Nomen der dritten Deklination der \textit{ǐ}-Stämme},label={GF-Morpho-Noun3i},basicstyle=\small]
oper
  -- i-declension
...
\begin{lstlisting}[float=h!,caption={Die Deklinationsfunktionen für die Nomen der vierten Deklination auf \textit{-us}},label={GF-Morpho-Noun4us},basicstyle=\small]
...
\begin{lstlisting}[float=h!,caption={Die Deklinationsfunktionen für die Nomen der vierten Deklination auf \textit{-u}},label={GF-Morpho-Noun4u},basicstyle=\small]
...
\begin{lstlisting}[float=h!,caption={Die Deklinationsfunktionen für die Nomen der fünften Deklination},label={GF-Morpho-Noun5},basicstyle=\small]
oper
  -- e-Declension
  noun5 : Str -> Noun = \res -> 
    let
...
\begin{lstlisting}[float=h!,caption={Smart Paradigm für zwei Adjektivformen (vgl. \textbf{MorphoLat.gf})},label={GF-Morpho-Adj},basicstyle=\small]
oper
...
\begin{lstlisting}[float=h!,caption={Smart Paradigm für zwei Adjektivformen (vgl. \textbf{MorphoLat.gf})},label={GF-Morpho-Adj123},basicstyle=\small]
oper
...
\begin{lstlisting}[float=h!,caption={Deklinationsfunktion für drei-endige Adjektive der ersten und zweiten Deklination (vgl. \textbf{MorphoLat.gf})},label={GF-Morpho-Adj12},basicstyle=\small]
oper
...
\begin{lstlisting}[float=h!,caption={Funktion zur Bestimmung der Komparativ- und Superlativformen eines Adjektivs (vgl. \textbf{MorphoLat.gf})},label={GF-Morpho-CompSuper},basicstyle=\small]
oper
...
\begin{lstlisting}[float=h!,caption={Erzeugung der Komparativ-Formen eines Adjektivs (vgl. \textbf{MorphoLat.gf})},label={GF-Morpho-Comp},basicstyle=\small]
oper
...
\begin{lstlisting}[float=h!,caption={Erzeugung der Superlativ-Formen eines Adjektivs (vgl. \textbf{MorphoLat.gf})},label={GF-Morpho-Comp},basicstyle=\small]
oper
...
\FloatBarrier
\subsubsection{Dritte Deklination}
\begin{lstlisting}[float=h!,caption={Deklinationsfunktion für zwei- und drei-endige Adjektive der dritten Deklination (vgl. \textbf{MorphoLat.gf})},label={GF-Morpho-Adj3x},basicstyle=\small]
oper
...
\begin{lstlisting}[float=h!,caption={Deklinationsfunktion für die "`Nomenformen"' der Adjektive der dritten Deklination (vgl. \textbf{MorphoLat.gf})},label={GF-Res-Noun3Adj},basicstyle=\small]
...
\begin{lstlisting}[label={GF-Res-Verb},float=h!,caption={Datentyp eines Verbs im Grammatical Framework},basicstyle=\footnotesize]
param
