...
\begin{lstlisting}[float=h!tp,caption={Die Deklinationsfunktionen für die Nomen der fünften Deklination (cgl. \textbf{MorphoLat.gf})},label={GF-Morpho-Noun5},basicstyle=\small]
oper
  -- e-Declension
  noun5 : Str -> Noun = \res -> 
    let
