...
--  beg_V2V = mkV2V (mkV "petere") abP ; -- -tivi/tii, -titum 3 L...
  ...
  bread_N = ( variants { (mkN "panis" "panis" masculine ) ; mkN "pane" } ); -- -is m./n. L...
...
--  paris_PN = mkPN (mkN "Lutetia") ; -- -ae f. http://la.wikipedia.org/wiki/Lutetia
  ...
  plastic_N = mkN "plasticum" "plasticae" feminine ; -- -ae f. http://la.wikipedia.org/wiki/Plasticum
...
--  sleep_V = mkV "dormio" "dormivi" "dormitus" "dormire" ; -- Ranta; 
  ...
  snake_N = mkN "serpens" "serpendis" ( variants { masculine ; feminine } ) ; -- -entis m./f. L...
...
--  animal_N = mkN "animal" ; -- -alis n. L...
  ashes_N = mkN "cinis" "cineris" ( variants { masculine ; feminine } ) ; -- -eris m./(f.) L... 
...
--  head_N = mkN "caput" ; -- -itis n. L...
  ...
  leg_N = bone_N ;
  liver_N = variants { ( mkN "iecur" "iecuris" neuter ) ; ( mkN "iocur" "iocuris" neuter ) } ; -- iecoris/iocineris n. L...
