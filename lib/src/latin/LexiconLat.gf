...
lin
  ...
  beg_V2V = mkV2V ( mkV "petere" "peto" "petivi" "petitum" ) "ab" False ; -- peto, -tivi/tii, -titum 3 L...
  ...
  break_V2 = mkV2 ( mkV "rumpere" "rumpo" "rupi" "ruptum" ) ; -- Ranta; 3 L...
...
--  fun_AV = mkAV (mkA "iocosus") ; -- 3 L...
  ...
  hate_V2 = mkV2 (mkV "odisse" "odi" "osurus") ; -- odi, osurus/odivi L...
...
--  have_V2 = mkV2 (mkV "habere") ; -- habeo, -ui, -itum 2 L...
  ...
  learn_V2 = mkV2 (mkV "discere" "disco" "didici") ; -- disco, didici, - 3 (-isc-?) L...
  leather_N = mkN "scortum" ; -- -i n. L...
  leave_V2 = mkV2 (mkV "relinquere" "relinquo" "relinqui" "relictum") ; -- relinquo, relinqui, relictum 3 L...
  like_V2 = mkV2 ( lin V ResLat.want_V ) noPrep ; -- vello, velli (volsi, vulsi), vulsum 3 L...
...
--  married_A2 = mkA2 (mkA "coniunctus") noPrep ; -- 3 http://www.perseus.tufts.edu/hopper/text?doc=Perseus:text:1999.04.0060:entry=coniunctus&highlight=married
  ...
  paint_V2A = mkV2A (mkV "pingere" "pingo" "pinxi" "pictum" ) noPrep ; -- pingo, pinxi, pictum 3 L...
...
--  rain_V0 = mkV0 (mkV "pluit") ; -- L...
  ...
  say_VS = mkVS (mkV "dicere" "dico" "dixi" "dictum") ; -- dico, dixi, dictum 3 L...
  school_N = mkN "schola" ; -- -ae f. L...
  -- Irregular
--  science_N = mkN "literae" ; -- nur pl. L...
  sea_N = mkN "mare" "maris" neuter ; -- -is n. L...
  seek_V2 = mkV2 (mkV "quaerere" "quaero" "quaesivi" "quaesitum" ) ; -- quaero, quaesivi, quaesitum 3 L...
  see_V2 = mkV2 (mkV "videre") ; -- video, vidi, visum 2 L...
  sell_V3 = mkV3 ( mkV "vendere" "vendo" "vendidi" "venditum" ) noPrep toP ; -- vendo, vendidi, venditum 3 L...
  send_V3 = mkV3 ( mkV "mittere" "mitto" "misi" "missum" ) noPrep toP ; -- mitto, misi, missum 3 L...
...
--  sleep_V = mkV "dormio" "dormivi" "dormitus" "dormire" ; -- Ranta; 
  ...
  talk_V3 = mkV3 ( lin V speak_V2 ) noPrep noPrep ;
...
---- trousers_N = mkN "trousers" ;
  ...
  add_V3 = mkV3 ( mkV "addere" "addo" "addidi" "additum" ) noPrep toP ; -- addo, addidi, additum 3 L...
  number_N = mkN "numerus" ; -- -i m.
  put_V2 = mkV2 (mkV "ponere" "pono" "posui" "positum" ) ; -- pono, posui, positum 3 L...
  stop_V = mkV "sistere" "sisto" "steti" "statum" ; -- sisto, stiti/steti, statum 3 L...
  ...
  ashes_N = mkN "cinis" "cineris" masculine ; -- -eris m. L... & Bayer-Lindauer 33 1.2 
  ...
  dig_V = mkV "fodere" "fodio" "fodi" "fossum" ; -- fodio, fodi, fossum 3 L...
  fall_V = mkV "caedere" "caedo" "cecidi" "caesum" ; -- caedo, cecidi, caesum 3 L...
  float_V = mkV "fluitere" ; -- fluito 1 L...
  flow_V = mkV "fluere" "fluo" "fluxi" "fluctum" ; -- fluo, fluxi, fluxum 3 L...
...
--  give_V3 = mkV3 give_V toP ;
  ...
  pull_V2 = mkV2 (mkV "trahere" "traho" "traxi" "tractum" ) ; -- traho, traxi, tractum 3 L...
  push_V2 = mkV2 (mkV "premere" "premo" "pressi" "pressum" ) ; -- premo, pressi, pressum 3 L...
  rub_V2 = mkV2 (mkV "radere" "rado" "rasi" "rasum" ) ; -- raso, -si, -sum 3 L...
  scratch_V2 = mkV2 (mkV "scalpere" "scalpo" "scalpsi" "scalptum" ) ; -- scalpo, -psi, -ptum 3 L...
  split_V2 = mkV2 ( mkV "scindere" "scindo" "scidi" "scissum" ) ; -- scindo, -idi, -issum 3 L...
  squeeze_V2 = mkV2 (mkV "premere" "premo" "pressi" "pressum" ) ; -- premo, pressi, pressum 3 L... 
  stab_V2 = mkV2 (mkV "transfigere" "transfigo" "transfixi" "transfixum") ; -- -figo, -fixi, fixum 3 L...
  suck_V2 = mkV2 (mkV "fellare") ; -- fel(l)o 1 L...
  throw_V2 = mkV2 (mkV "iacere" "iacio" "ieci" "iactum" ) ; -- iacio, ieci, iactum 3 L...
  tie_V2 = mkV2 (mkV "vincire") ; -- vincio, vinxi, vinctum 4 L...
  wash_V2 = mkV2 (mkV "lavare") ; -- lavo, lavi, lautum (lotum)/lavatum 1 L...
  wipe_V2 = mkV2 (mkV "detergere") ; -- detergeo, -tersi, -tersum 2/ detergo, -, - 3 L...
...
-- Bayer-Lindauer $149ff.
  aboutP = lin Prep (mkPrep "de" Gen ) ; -- L...
  atP = lin Prep (mkPrep "ad" Acc ) ; -- L...
  forP = lin Prep (mkPrep "pro" Abl ) ; -- L...
  fromP = lin Prep ( mkPrep "ab" Abl ) ; -- L...
  inP = lin Prep ( mkPrep "in" ( variants { Abl ; Acc } ) ) ; -- L...
  onP = lin Prep ( mkPrep "ad" Gen ) ; -- L...
  toP = lin Prep ( mkPrep "ad" Acc ) ; -- L...
  noPrep = lin Prep ( mkPrep "" Gen ) ;
}
