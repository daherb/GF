...
--  carpet_N = mkN "teges pavimenti" ; -- -entis f. http://la.wikipedia.org/wiki/Teges_pavimenti
  ...
  city_N = mkN "urbs" ; -- Ranta; urbis f. L...
  ...
  cow_N = mkN "bos" ; -- bovis (gen. pl. boum, dat./abl. pl. bobus/bubus) m./f. L...
-- Breaks verb
...
--  rain_V0 = mkV0 (mkV "pluit") ; -- L...
  ...
  rubber_N = mkN "cummis" ; -- -is f. Der kleine Stowasser
