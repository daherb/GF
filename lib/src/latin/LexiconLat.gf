...
lin
  ...
  answer_V2S = mkV2S (mkV "respondere") noPrep ; -- -spondeo, -spondi, -sponsum 2 Langenscheidts Schulwoerterbuch Lateinisch
  ...
  ask_V2Q = mkV2Q (mkV "rogare") noPrep ; -- rogo 1 Langenscheidts Schulwoerterbuch Lateinisch  
  ...
  become_VA = mkVA (mkV "fieri")  ; -- fio, factus Langenscheidts Schulwoerterbuch Lateinisch
  beer_N = mkN "cerevisia" ; -- Ranta
  beg_V2V = mkV2V (mkV "petere") abP ; -- -tivi/tii, -titum 3 Langenscheidts Schulwoerterbuch Lateinisch
  ...
  blue_A = mkA ( variants { "caeruleus" ; "caerulus" } ) ; -- 3 Langenscheidts Schulwoerterbuch Lateinisch
  ...
  listen_V2 = mkV2 (mkV "auscultare") toP ; -- ausculto 1 L...
  ...
  mother_N2 = mkN2 (mkN "mater") noPrep ; -- matris f. L...
  ...
  open_V2 = dirV2 (mkV "aperire") ; -- aperio, aperui, apertum 4 L...
  ...
  priest_N = mkN "sacerdos" ; -- -dotis m./f. L...
  ...
  send_V3 = mkV3 (irmkV "mittere") toP ; -- mitto, misi, missum 3 L...
  sheep_N = mkN "ovis" ; -- -is f. L...
...
---- trousers_N = mkN "trousers" ;
  ...
  understand_V2 = mkV2 (irmkV "intellegere") ; -- intellego, intellexi, intellectum 3 L...
  university_N = mkN "universitas" ; -- -atis f. http://la.wikipedia.org/wiki/Universitas and L...
  village_N = mkN "vicus" ; -- -i m. L...
  wait_V2 = mkV2 (mkV "exspectare") forP ; -- 1 L...
  ...
  put_V2 = mkV2 (mkV "ponere") noPrep ; -- pono, posui, positum 3 L...
  ...
  sit_V = mkV "sedeo" ; -- sedi, sessum 2 L...
  ...
  bite_V2 = mkV "mordere" ; -- mordeo, momordi, morsum 2 L...
...
--  squeeze_V2 = mkV2 (mkV "squeeze") ;
--  stab_V2 = mkV2 (mkV "stab") ;
--  suck_V2 = mkV2 (mkV "suck") ;
--  throw_V2 = mkV2 throw_V ;
--  tie_V2 = mkV2 (mkV "tie") ;
--  wash_V2 = mkV2 (mkV "wash") ;
--  wipe_V2 = mkV2 (mkV "wipe") ;
